...
document.getElementById("sketchname").innerHTML="<span>Sketch to be drawn: "+sketch+"</span>";
...
function gotResults(error, results){
    if(error){
        ...
        document.getElementById("sketchdisplay").innerHTML="Your sketch: "+drawn_sketch;
        document.getElementById("conf").innerHTML="Confidence: "+Math.floor(100*results[0].confidence)+"%";
    }
}